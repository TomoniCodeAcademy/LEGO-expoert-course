...
def search_tag():
    ...
    print('set camera horizontal(for tag)')
...
def carry_ball_to_goal():
    print('search tag(goal post)')
    if search_tag():
        approach_to_tag()

#
# must refine this routine 
#
while True:
    print('search ball')
