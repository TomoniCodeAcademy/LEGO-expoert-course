...
- [2_PythonでLEGOを制御](2_PythonでLEGOを制御)
  ...
  - [2_1_LEGO_HUB_beep](2_1_LEGO_HUB_beep.ipynb)
  - [2_2_HUBのLEDを光らせる](2_2_HUBのLEDを光らせる.ipynb)
  - [2_4_押しボタンスイッチを使う](2_4_押しボタンスイッチを使う.ipynb)
  - [2_5_距離センサを使う](2_5_距離センサを使う.ipynb)
  - [2_6_カラーセンサを使う](2_6_カラーセンサを使う.ipynb)
  - [2_7_モーションセンサを使う](2_7_モーションセンサを使う.ipynb)
  - [2_8_サーボを使う](2_8_サーボを使う.ipynb)
  - [2_9_２つのサーボをペアで使う](2_9_２つのサーボをペアで使う.ipynb)
